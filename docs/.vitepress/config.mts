...
export default defineConfig({
  ...
  lastUpdated: true,
  description:
    "Chry's Tech Blog: An undergraduate's journey through backend development, sharing insights, tips, and experiences in web technologies.",
  ...
  themeConfig: {
    ...
    // 顶部导航栏左侧的社交平台跳转
    socialLinks: [{ icon: "github", link: "https://github.com/1CHRY1" }],
    // 首页底部版权声明
    footer: {
      copyright: "Copyright © 2024 Chry",
    },
    // 文章内导航栏标题
    outlineTitle: "导航栏",
  },
